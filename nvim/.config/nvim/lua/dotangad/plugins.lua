...
return require('packer').startup(function(use)
  ...
  use {
    ...
    config = function ()
      ...
      vim.keymap.set('n', '<leader>fs', require('telescope.builtin').current_buffer_fuzzy_find, { desc = 'Find in buffer' })
      vim.keymap.set('n', '<C-s>', require('telescope.builtin').current_buffer_fuzzy_find, { desc = 'Swiper stop swiping' })

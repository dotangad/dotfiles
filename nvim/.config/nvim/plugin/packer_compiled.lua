...
_G.packer_plugins = {
  ...
  ["html5.vim"] = {
    loaded = true,
    path = "/Users/angad/.local/share/nvim/site/pack/packer/start/html5.vim",
  ...
  ["landscape.vim"] = {
    loaded = true,
    path = "/Users/angad/.local/share/nvim/site/pack/packer/start/landscape.vim",
  ...
  sonokai = {
    loaded = true,
    path = "/Users/angad/.local/share/nvim/site/pack/packer/start/sonokai",
  ...
  ["vim-eldar"] = {
    loaded = true,
    path = "/Users/angad/.local/share/nvim/site/pack/packer/start/vim-eldar",
  ...
  ["vim-javascript"] = {
    loaded = true,
    path = "/Users/angad/.local/share/nvim/site/pack/packer/start/vim-javascript",
  ...
  ["vim-svelte"] = {
    config = { "\27LJ\2\nÕ\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0µ\1        let g:svelte_preprocessor_tags = [\n          \\ { 'name': 'postcss', 'tag': 'style', 'as': 'scss' }\n          \\ ]\n        let g:svelte_preprocessors = ['postcss']\n      \bcmd\bvim\0" },
    loaded = true,

...
set fish_color_command A6E22E # the color for commands
...
set fish_color_error F92472 # the color used to highlight potential errors
set fish_color_param F8F8F2 # the color for regular command parameters
